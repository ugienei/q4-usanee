    ...
    <article>
      ...
      <div class="product-list">
        ...
        while ($row = $stmt->fetch()) {
          ...
          echo "<a href='Edit_Product_from.php?username=" . $row["username"] . "' class='edit-bt'>แก้ไข</a>";
          echo "<a href='Delete_Product.php' onclick=\"confirm_delete_member('{$row["username"]}')\" class='delete-bt'>ลบ</a>";
          echo "</div>";
          echo "<hr>\n";
        }
        ?>
